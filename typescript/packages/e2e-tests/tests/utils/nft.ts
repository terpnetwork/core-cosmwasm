...
import { FactoryUtilsExecuteMsgForVendingMinterInitMsgExtension } from '../types/vendingMinter'
...
export const createMinter = async (context: Context) => {
  ...
  let msg: FactoryUtilsExecuteMsgForVendingMinterInitMsgExtension = {
    create_minter: {
      init_msg: {
        ...
        num_tokens: 10_000,
        mint_price: { amount: '1000000', denom: 'uterp' },
