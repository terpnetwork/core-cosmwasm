...
fn test_create_minter(chain: &mut Chain) {
    ...
    let valid_minter_msg = FactoryUtilsExecuteMsg::CreateMinter(create_minter_msg(
        chain,
        None,
        user_addr.to_string(),
        MAX_TOKENS,
    ...
    let invalid_code_id_minter_msg = FactoryUtilsExecuteMsg::CreateMinter(create_minter_msg(
        chain,
        Some(777u64),
        user_addr.to_string(),
        MAX_TOKENS,
    ...
    // invalid nft data
    let invalid_nft_data_minter_msg = FactoryUtilsExecuteMsg::CreateMinter(create_minter_msg(
        chain,
        None,
        user_addr.to_string(),
        MAX_TOKENS,
...
fn test_start_trading_time(chain: &mut Chain) {
    ...
    let invalid_minter_msg = FactoryUtilsExecuteMsg::CreateMinter(create_minter_msg(
        chain,
        None,
        user_addr.to_string(),
        MAX_TOKENS,
    ...
    // Valid
    let minter_msg = FactoryUtilsExecuteMsg::CreateMinter(create_minter_msg(
        chain,
        None,
        user_addr.to_string(),
        MAX_TOKENS,
