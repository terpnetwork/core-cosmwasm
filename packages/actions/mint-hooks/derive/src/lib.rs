...
///
/// For example, apply the `terp_mint_hooks_execute` macro to the following enum:
///
/// ```rust
...
/// ```
///
/// Note: `#[terp_mint_hooks_execute]` must be applied _before_ `#[cw_serde]`.
#[proc_macro_attribute]
pub fn terp_mint_hooks_execute(metadata: TokenStream, input: TokenStream) -> TokenStream {
    merge_variants(
        metadata,
        input,
        quote! {
