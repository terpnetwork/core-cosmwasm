...
use earlybird_immutable::helpers::EarlybirdImmutableContract;
...
#[test]
fn test_earlybird_immutable_address_limit() {
    let addresses: Vec<String> = vec![
        "addr1".to_string(),
        "addr2".to_string(),
        "addr3".to_string(),
    ...
    instantiate_contract(params).unwrap();
    let earlybird_immutable = Addr::unchecked("contract4");
    let res: u32 = EarlybirdImmutableContract(earlybird_immutable)
...
#[test]
fn test_earlybird_immutable_address_count() {
    let addresses: Vec<String> = vec![
        "addr1".to_string(),
        "addr2".to_string(),
        "addr3".to_string(),
    ...
    instantiate_contract(params).unwrap();
    let earlybird_immutable = Addr::unchecked("contract4");
    let res: u64 = EarlybirdImmutableContract(earlybird_immutable)
...
#[test]
fn test_earlybird_immutable_address_includes() {
    let addresses: Vec<String> = vec![
        "addr1".to_string(),
        "addr2".to_string(),
        "addr3".to_string(),
    ...
    instantiate_contract(params).unwrap();
    let earlybird_immutable = Addr::unchecked("contract4");
    let res: bool = EarlybirdImmutableContract(earlybird_immutable.clone())
        .includes(&app.wrap(), "addr3".to_string())
        .unwrap();
    assert!(res);

    let res: bool = EarlybirdImmutableContract(earlybird_immutable)
...
#[test]
fn test_earlybird_immutable_address_config() {
    let addresses: Vec<String> = vec![
        "addr1".to_string(),
        "addr2".to_string(),
        "addr3".to_string(),
    ...
    instantiate_contract(params).unwrap();
    let earlybird_immutable = Addr::unchecked("contract4");
    let res: earlybird_immutable::state::Config = EarlybirdImmutableContract(earlybird_immutable)
        .config(&app.wrap())
        .unwrap();
    let expected_config = earlybird_immutable::state::Config {
