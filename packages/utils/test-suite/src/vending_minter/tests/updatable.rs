...
use terp721_updatable::msg::ExecuteMsg as Terp721UpdatableExecMsg;
...
use crate::common_setup::{
    ...
    templates::vending_minter_with_terp721_updatable,
};

#[test]
fn update_token_metadata() {
    // create updatable collection and minter
    let vt = vending_minter_with_terp721_updatable(10);
    ...
    let msg = Terp721UpdatableExecMsg::<Empty, Empty>::UpdateTokenMetadata {
