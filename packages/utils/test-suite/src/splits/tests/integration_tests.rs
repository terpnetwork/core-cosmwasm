...
mod tests {
    ...
    use terp_code_controllers::ContractInstantiateMsg;
    use terp_splits::contract::MAX_GROUP_SIZE;
    use terp_splits::msg::Group;
    use terp_splits::{
    ...
    mod distribute {
        ...
        use super::*;
        use terp_splits::msg::{ExecuteMsg, QueryMsg};
