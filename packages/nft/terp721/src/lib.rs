...
pub struct UpdateCollectionInfoMsg<T> {
    ...
    pub explicit_content: Option<bool>,
    pub residual_info: Option<Option<T>>,
}
...
// allows easy conversion from ResidualInfo to ResidualInfoResponse
impl ResidualInfo {
    pub fn to_response(&self) -> ResidualInfoResponse {
        ResidualInfoResponse {
...
#[cw_serde]
pub struct ResidualInfoResponse {
...
pub struct InstantiateMsg {
    ...
    pub symbol: String,
    pub minter: String,
    pub collection_info: CollectionInfo<ResidualInfoResponse>,
}
