...
mod tests {
    ...
    mod init {
        ...
        use factory_utils::query::{AllowedCollectionCodeIdResponse, AllowedCollectionCodeIdsResponse};
        ...
        fn query_allowed_collection_code_ids_test() {
            let (app, factory_contract, params) = proper_instantiate();
            let query_config_msg = factory_utils::query::FactoryUtilsQueryMsg::AllowedCollectionCodeIds {};
