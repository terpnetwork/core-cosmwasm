use crate::headstash_airdrop::constants::claim_constants::OWNER;
use crate::headstash_airdrop::constants::collection_constants::WHITELIST_AMOUNT;
use crate::{
    common_setup::contract_boxes::{contract_eth_airdrop, contract_earlybird_immutable},
    headstash_airdrop::setup::test_msgs::InstantiateParams,
};
...
pub fn instantiate_contract(params: InstantiateParams) -> Result<cosmwasm_std::Addr, anyhow_error> {
    ...
    let earlybird_code_id = params.app.store_code(contract_earlybird_immutable());
