...
mod tests {
    ...
    use crate::common_setup::contract_boxes::{contract_earlybird_immutable, custom_mock_app};
    ...
    pub fn instantiate_with_addresses(
        ...
        let wl_id = app.store_code(contract_earlybird_immutable());
    ...
    pub fn test_instantiate_empty_list_error() {
        ...
        let res = app
            ...
            .unwrap_err();
        let expected_error = "Empty earlybird, must provide at least one address";
    ...
    pub fn test_helper_query_address_limit() {
        ...
        let res: u32 = EarlybirdImmutableContract(wl_addr)
    ...
    pub fn test_helper_query_address_count() {
        ...
        let res: u64 = EarlybirdImmutableContract(wl_addr)
    ...
    pub fn test_helper_query_config() {
        ...
        let res: Config = EarlybirdImmutableContract(wl_addr)
            .config(&app.wrap())
            .unwrap();
    ...
    pub fn test_helper_query_includes() {
        ...
        let res: bool = EarlybirdImmutableContract(wl_addr.clone())
            .includes(&app.wrap(), "addr0003".to_string())
            .unwrap();
        assert!(res);

        let res: bool = EarlybirdImmutableContract(wl_addr)
