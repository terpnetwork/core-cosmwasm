...
pub struct CollectionInfoResponse {
    ...
    pub residual_info: Option<ResidualInfoResponse>,
}
...
impl CollectionInfoResponse {
    pub fn royalty_payout(
        ...
        if let Some(residual_info) = self.residual_info.as_ref() {
            ...
            res.messages.push(SubMsg::new(BankMsg::Send {
                to_address: residual_info.payment_address.to_string(),
            ...
            let event = Event::new("royalty-payout")
                ...
                .add_attribute("recipient", residual_info.payment_address.to_string());
