...
pub use terp721_base::ContractError;
use terp_metadata::Metadata;

pub type Sg721MetadataContract<'a> = terp721_base::Terp721Contract<'a, Metadata>;
pub type InstantiateMsg = terp721::InstantiateMsg;
pub type ExecuteMsg = terp721::ExecuteMsg<Metadata, Empty>;
pub type QueryMsg = terp721_base::msg::QueryMsg;

// version info for migration info
const CONTRACT_NAME: &str = "crates.io:terp721-metadata-onchain";
...
pub mod entry {
    ...
    use terp721_base::{msg::QueryMsg, ContractError};
    ...
    pub fn migrate(deps: DepsMut, _env: Env, _msg: Empty) -> Result<Response, ContractError> {
        ...
        let cw17_res = cw721_base::upgrades::v0_17::migrate::<Extension, Empty, Empty, Empty>(deps)
            .map_err(|e| terp721_base::ContractError::MigrationError(e.to_string()))?;
...
mod tests {
    ...
    use terp721::{CollectionInfo, ExecuteMsg, InstantiateMsg};
